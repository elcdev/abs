...
AUTH: ALEZHU
DATE: 20.09.2005
DES:  Export parameters for file export
***************************************
*/
...
e_BtAttach   AT COL 16 ROW 4 HELP "F1-S­t¨t/Saglab–t/Turpin–t;F4-Izeja;"
e_BtCnv      AT COL 16 ROW 5 HELP "F1-S­t¨t/Saglab–t/Turpin–t;F4-Izeja;"
e_BtProtokol AT COL 16 ROW 6 HELP "F1-S­t¨t/Saglab–t;F4-Izeja;"
...
PROCEDURE ShowMf:
    ...
    /*MESSAGE e_CodePage VIEW-AS ALERT-BOX.*/
    e_BtCnv:LABEL IN FRAME Mf = cext:Gt(e_CodePage, "CP_CONVERSION", "Unknown").
