     DEFINE STATIC PUBLIC VARIABLE defaultRootKeyId AS INT64 NO-UNDO INITIAL 1.
     
	 /* Supports key like path [/syste/key/name] */
     METHOD STATIC PUBLIC INT64 getKeyId(iKeyName AS CHAR):
        RETURN getKeyId(defaultRootKeyId, iKeyName, 0).
     END.
     
	 METHOD STATIC PUBLIC INT64 getKeyId(iParentId AS INT64, iKeyName AS CHAR):
        RETURN getKeyId(iParentId, iKeyName, 0).
     END.
	 
     METHOD STATIC PUBLIC INT64 getKeyId(iParentId AS INT64, iKeyName AS CHARACTER, iLevel AS INT):
		...
		DEF BUFFER {&tableName} FOR {&tableName}.
     ...
     METHOD STATIC PUBLIC CHARACTER getValueChar(iParentId AS INT64, iKeyName AS CHAR):
     ...
     END.
     METHOD STATIC PUBLIC LONGCHAR getValueLongChar(iParentId AS INT64, iKeyName AS CHAR):
        DEFINE VARIABLE oValue AS LONGCHAR NO-UNDO.
        oValue = getValueChar(iParentId, iKeyName).
        RETURN oValue.
     END.
     METHOD STATIC PUBLIC DEC getValueDec(iParentId AS INT64, iKeyName AS CHAR):
        DEFINE VARIABLE oValue AS DECIMAL NO-UNDO.
        oValue = DECIMAL(getValueChar(iParentId, iKeyName)) NO-ERROR.
        RETURN oValue.
     END.
     METHOD STATIC PUBLIC INT64 getValueInt64(iParentId AS INT64, iKeyName AS CHAR):
        DEFINE VARIABLE oValue AS INT64 NO-UNDO.
        oValue = INT64(getValueChar(iParentId, iKeyName)) NO-ERROR.
        RETURN oValue.
     END.
     METHOD STATIC PUBLIC INT getValueInt(iParentId AS INT64, iKeyName AS CHAR):
        DEFINE VARIABLE oValue AS INT NO-UNDO.
        oValue = INT(getValueChar(iParentId, iKeyName)) NO-ERROR.
        RETURN oValue.
     END.
     METHOD STATIC PUBLIC LOG getValueLog(iParentId AS INT64, iKeyName AS CHARACTER):
        RETURN getValueLog(iParentId, iKeyName, "").
     END.
     METHOD STATIC PUBLIC LOG getValueLog(iParentId AS INT64, iKeyName AS CHARACTER, iFormat AS CHAR):
        ...
        RETURN oValue.
     END.
     METHOD STATIC PUBLIC DATE getValueDate(iParentId AS INT64, iKeyName AS CHAR):
        DEFINE VARIABLE oValue AS DATE NO-UNDO.
        oValue = DATE(getValueChar(iParentId, iKeyName)) NO-ERROR.
        RETURN oValue.
     END.
     METHOD STATIC PUBLIC DATETIME getValueDatetime(iParentId AS INT64, iKeyName AS CHAR):
     ...
     METHOD STATIC PUBLIC CHARACTER getValueChar(iKeyName AS CHAR):
        RETURN getValueChar(defaultRootKeyId, iKeyName).
     END.
     METHOD STATIC PUBLIC LONGCHAR getValueLongChar(iKeyName AS CHAR):
        RETURN getValueLongChar(defaultRootKeyId, iKeyName).
     END.
     METHOD STATIC PUBLIC DEC getValueDec(iKeyName AS CHAR):
        RETURN getValueDec(defaultRootKeyId, iKeyName).
     END.
     METHOD STATIC PUBLIC INT getValueInt(iKeyName AS CHAR):
        RETURN getValueInt(defaultRootKeyId, iKeyName).
     END.
     METHOD STATIC PUBLIC INT64 getValueInt64(iKeyName AS CHAR):
        RETURN getValueInt64(defaultRootKeyId, iKeyName).
     END.
     METHOD STATIC PUBLIC LOG getValueLog(iKeyName AS CHARACTER):
        RETURN getValueLog(defaultRootKeyId, iKeyName, "").
     END.
     METHOD STATIC PUBLIC LOG getValueLog(iKeyName AS CHARACTER, iFormat AS CHAR):
        RETURN getValueLog(defaultRootKeyId, iKeyName, iFormat).
     END.
     METHOD STATIC PUBLIC DATE getValueDate(iKeyName AS CHAR):
        RETURN getValueDate(defaultRootKeyId, iKeyName).
     END.
     METHOD STATIC PUBLIC DATETIME getValueDatetime(iKeyName AS CHAR):
